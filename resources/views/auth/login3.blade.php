            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                ...
                <form action="{{ route('login') }}" method="POST">
                    ...
                    <div class="form-group">
                      <input type="password" name="password" class="form-control form-control-user @error('password') is-invalid @enderror" id="exampleInputPassword" required autocomplete="current-password"
